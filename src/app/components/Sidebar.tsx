    ...
    return (
        <aside style={{display:'flex', flexDirection:'column', justifyContent:'space-between', width:'250px', height:'100vh', backgroundColor:'#ffffff', borderRight:'1px solid #f0f0f0', paddingLeft:'0px', paddingRight:'20px', paddingTop:'0px', marginLeft:'0px'}}>    
            <div>
                ...
                <div onClick={() => setActivePage("Dashboard")} style={{display:'flex', alignItems:'center', gap:'8px', paddingTop:'6px', paddingBottom:'6px', paddingRight:'10px', paddingLeft:'20px', borderRadius:'12px', backgroundColor: activePage === "Dashboard" ? '#E8F5F3' : 'transparent', cursor:'pointer', marginBottom:'4px'}}>
                ...
                <div onClick={() => setActivePage("History")} style={{display:'flex', alignItems:'center', gap:'8px', paddingTop:'6px', paddingBottom:'6px', paddingRight:'10px', paddingLeft:'20px', borderRadius:'12px', backgroundColor: activePage === "History" ? '#E8F5F3' : 'transparent', cursor:'pointer', marginBottom:'4px'}}>
                ...
                <div onClick={() => setActivePage("Insights")} style={{display:'flex', alignItems:'center', gap:'8px', paddingTop:'6px', paddingBottom:'6px', paddingRight:'10px', paddingLeft:'20px', borderRadius:'12px', backgroundColor: activePage === "Insights" ? '#E8F5F3' : 'transparent', cursor:'pointer', marginBottom:'4px'}}>
                ...
                <div onClick={() => setActivePage("Transactions")} style={{display:'flex', alignItems:'center', gap:'8px', paddingTop:'6px', paddingBottom:'6px', paddingRight:'10px', paddingLeft:'20px', borderRadius:'12px', backgroundColor: activePage === "Transactions" ? '#E8F5F3' : 'transparent', cursor:'pointer', marginBottom:'4px'}}>
                ...
                <div onClick={() => setActivePage("Wallet")} style={{display:'flex', alignItems:'center', gap:'8px', paddingTop:'6px', paddingBottom:'6px', paddingRight:'10px', paddingLeft:'20px', borderRadius:'12px', backgroundColor: activePage === "Wallet" ? '#E8F5F3' : 'transparent', cursor:'pointer', marginBottom:'4px'}}>
                ...
                <div onClick={() => setActivePage("Settings")} style={{display:'flex', alignItems:'center', gap:'8px', paddingTop:'6px', paddingBottom:'6px', paddingRight:'10px', paddingLeft:'20px', borderRadius:'12px', backgroundColor: activePage === "Settings" ? '#E8F5F3' : 'transparent', cursor:'pointer', marginBottom:'4px'}}>
            ...
            <div style={{padding:'16px', margin:'20px', backgroundColor:'#E8F5F3', borderRadius:'15px'}}>
                ...
                <div style={{backgroundColor:'#e8f5f3', borderRadius:'999px', height:'6px', marginTop:'8px'}}>
